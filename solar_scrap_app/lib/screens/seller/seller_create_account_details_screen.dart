...
class SellerCreateAccountDetailsScreen extends StatefulWidget {
  final RegistrationData data;

  const SellerCreateAccountDetailsScreen({
    super.key,
    required this.data,
  });

  @override
  State<SellerCreateAccountDetailsScreen> createState() =>
      _SellerCreateAccountDetailsScreenState();
}

class _SellerCreateAccountDetailsScreenState
    extends State<SellerCreateAccountDetailsScreen> {
  ...
  File? _profileImage;
  String _companyType = 'Solar Plant Owner';
  double? _latitude;
  double? _longitude;
  ...
  void initState() {
    ...
    _companyType = widget.data.companyType ?? 'Solar Plant Owner';
  ...
  void _handleContinue() {
    ...
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (_) => SellerCreateAccountVerifyOtpScreen(data: widget.data),
      ),
    );
  }
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          TextFormField(
                            ...
                            style: GoogleFonts.poppins(fontSize: 14),
                            decoration: _inputDecoration(
                              hint: 'e.g. Sundar Industrial Estate',
