...
class BuyerCreateAccountSecurityScreen extends StatefulWidget {
  const BuyerCreateAccountSecurityScreen({super.key});

  @override
  State<BuyerCreateAccountSecurityScreen> createState() =>
      _BuyerCreateAccountSecurityScreenState();
}

class _BuyerCreateAccountSecurityScreenState
    extends State<BuyerCreateAccountSecurityScreen> {
        ...
        child: SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              Opacity(
                opacity: _agreeTerms && _agreePrivacy ? 1.0 : 0.5,
                child: Container(
